...
// Obtener el ID del usuario a editar (puedes pasarlo como un parámetro GET)
if(isset($_GET['id'])){
    $id_usuario = $_GET['id'];

    // Consulta SQL para obtener los datos del usuario
    
    $consulta = "SELECT id, nombre, usuario, clave FROM usuarios WHERE id = $id_usuario";
...
<link rel="stylesheet" href="./includes/bulma.min.css">
...
<div class="container pb-6 pt-6">
    ...
    <!-- a donde se ira aprocesar los datos ingresados en el formulario -->

    <form action="./actulizar_usu.php" method="POST" class="FormularioAjax" autocomplete="off">
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>ID</label>
                    <input class="input" type="text" name="usuario_id" value="<?php echo $usuario['id']; ?>" disabled>
                </div>
            </div>
        </div>
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Nombres</label>
                    <input class="input" type="text" name="usuario_nombre" value="<?php echo $usuario['nombre']; ?>" autocomplete="off" maxlength="40" required>
                </div>
            </div>
        </div>
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Usuario</label>
                    <input class="input" type="text" name="usuario_usuario" value="<?php echo $usuario['usuario']; ?>" autocomplete="off" maxlength="20" required>
                </div>
            </div>
        </div>
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Clave</label>
                    <input class="input" type="text" name="usuario_clave_1" value="<?php echo $usuario['clave']; ?>" autocomplete="off" maxlength="100" required>
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Repetir clave</label>
                    <input class="input" type="text" name="usuario_clave_2" value="<?php echo $usuario['clave']; ?>" autocomplete="off" maxlength="100" required>
                </div>
            </div>
        </div>
